    ...
    <div className="mt-5 w-full bg-white border border-gray-600 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      <a href="/">
        <img
          ...
          src="https://i.ytimg.com/vi/aROjE_C9fWo/hq720.jpg?sqp=-oaymwEcCNAFEJQDSFXyq4qpAw4IARUAAIhCGAFwAcABBg==&rs=AOn4CLCNE_NVvniXD084Q8mhvYswO0hrLQ"
          alt="product_image1"
        />
      </a>
      <div className="px-5 pb-5">
        <a href="/">
          <h5 className="text-xl mb-5 font-semibold tracking-tight text-gray-900 dark:text-white">
            ReactJS Context API Project
          </h5>
        </a>
        <div className="flex items-center mt-2.5 mb-6  justify-center">
          <svg
